    ...
    data() {
        return {
            ...
            btnitem: [{
                    ...
                    desc: 'La implementación de esta herramienta se desarrolla con fundamento en la Ley del Sistema Anticorrupción del Estado de Coahuila de Zaragoza y de la Ley General del Sistema Nacional Anticorrupción en su artículo 49, fracción V. en la cual se establece la obligación entre otros, de desarrollar el sistema de información denominado Sistema de denuncias públicas de faltas administrativas y hechos de corrupción.',
                    desc2: '',
                    src1: 'sistema1.jpg',
                    src2: 'sistema2.jpg',
                    link: '#'
